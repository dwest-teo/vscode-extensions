...
- Diagnostics now underline the entire diagnostic, rather than only the first character (closes [#87](https://github.com/xojs/vscode-linter-xo/issues/87))
...
- Adds a configuration for node runtime (closes [#103](https://github.com/xojs/vscode-linter-xo/issues/103))
