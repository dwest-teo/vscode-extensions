...
class LanguageServerInstaller {
    ...
    installPkg(release) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield vscode.workspace.fs.createDirectory(vscode.Uri.file(installDir)); // create install directory if missing
            const os = goOs();
            const arch = goArch();
            ...
            try {
                yield vscode.workspace.fs.delete(vscode.Uri.file(this.lsPath.binPath()));
            }
            catch (_a) {
                // ignore missing binary (new install)
            }
            try {
                yield vscode.workspace.fs.delete(vscode.Uri.file(this.lsPath.legacyBinPath()));
            }
            catch (_b) {
    ...
    cleanupZips() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield vscode.workspace.fs.delete(vscode.Uri.file(destination));
        });
    }
...
function getLsVersion(lsPath) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const e = yield vscode.workspace.fs.stat(p);
